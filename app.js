...
var entidad = require('./routes/entidad');
var estacion = require('./routes/estacion');
var datosEstacion = require('./routes/datosEstacion');
...
app.use('/api/datosEstacion', datosEstacion);
